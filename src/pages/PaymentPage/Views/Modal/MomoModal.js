      ...
      >
        ...
        >
          ...
          >
            ...
            <Button onClick={handleClose}>Change Other Payment Method</Button>
          </Box>
          <hr />
          <br />
          {/* Body */}
          ...
          >
            ...
            <Grid container item xs={12} md={6}>
              <Grid item xs={12} sm={12}>
                <Typography variant='h6'>Steps to Pay</Typography>
              </Grid>
              <Grid item xs={12} sm={12}>
                <Typography variant='h6'>1. Scan QR Code</Typography>
              </Grid>
              <Grid item xs={12} sm={12}>
                <Typography variant='h6'>2. Pay</Typography>
              </Grid>
              {/* Countdown time */}
              <Grid item xs={12} sm={12}>
                {time > 30 && (
